...
describe("lockComment", () => {
  ...
  it("should lock a comment", async () => {
    const userId = "user123";
    const commentId = "comment123";
    const postId = "post123";
    const subRedditId = "subReddit123";

    const comment = { isLocked: false, postId, save: jest.fn() };
  ...
  // Test when comment is not found
it("should handle comment not found", async () => {
  ...
  it("should handle comment already locked", async () => {
    const userId = "user123";
    const commentId = "comment123";
    const comment = { isLocked: true };
  ...
  it("should handle post not belonging to a subreddit", async () => {
    const userId = "user123";
    const commentId = "comment123";
    const comment = { isLocked: false, postId: "post123" };
