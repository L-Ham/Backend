const { hideNotification } = require('../../controllers/notificationController');
...
describe('hideNotification', () => {
  ...
  it('should hide notification and return 200', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith({ message: "Notification Hidden Successfully" });
  });
  ...
  it('should return 500 if there is an error', async () => {
    ...
    expect(res.json).toHaveBeenCalledWith({ message: "Error Hiding Notification", error: errorMessage });
  });
});